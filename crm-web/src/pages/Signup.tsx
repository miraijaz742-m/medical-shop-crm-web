            ...
            <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                <div className="hidden md:flex flex-col items-center justify-center">
                    ...
                    <div className="mt-4 text-center">
                        <h3 className="text-lg font-black text-slate-800 uppercase tracking-wider">Join Our Team</h3>
                        <p className="text-xs text-slate-500 font-bold mt-1">Enterprise-grade security for your pharmacy</p>
                    </div>
                </div>
