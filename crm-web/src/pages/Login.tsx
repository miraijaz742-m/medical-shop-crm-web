            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="flex p-1 bg-slate-200/50 rounded-xl mb-6">
                    <button
                        ...
                        className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${authMethod === 'password' ? 'bg-white shadow-sm text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
                    >
                        Password
                    </button>
                    <button
                        onClick={() => setAuthMethod('magic-link')}
                        className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${authMethod === 'magic-link' ? 'bg-white shadow-sm text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
                    >
                        Magic Link
                    </button>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 text-slate-400">
                    ...
                    <p className="text-center text-xs uppercase tracking-widest font-bold">
